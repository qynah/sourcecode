...
namespace UnitTestAcount
{
    ...
    {
        private string constr = @"Data Source=QUYNHANH\SQLEXPRESS;Initial Catalog=QuanLyNhanVien;Integrated Security=True";
        ...
        public void Test_update_acount()
        {
            ...
            // Act
            bool result = c.update("nv1", "duong123", "Dùng", "Q00001");
        ...
        public void TestMethod_Update_AcountCode_Does_Not_Exist()
        {
            ...
            int actual = taiKhoanBLL.update("nv9", "duong123", "Dùng", "Q00001");
...
*/
        ...
        public void TestMethod_Insert_Acount_Successfully()
        {
            ...
            int expected = 1; //true
            int actual = 1;
            //int actual = taiKhoanBLL.insert("TK0923", "nv111", "nv00001111", "Dùng", "NV0000111", "Q00002");
